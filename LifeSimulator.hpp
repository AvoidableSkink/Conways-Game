...
public:
  ...
  // You'll want to set these equal to the width/height of the console the
  // program runs within.
  ...
  void insertPattern(const Pattern &pattern, std::uint8_t startX,
                     std::uint8_t startY);
  // update - Performs a single step update of the world, following the four
  // rules specified in the wiki article.
  void update();
